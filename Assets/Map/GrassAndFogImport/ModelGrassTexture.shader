Shader "Unlit/ModelGrassTexture" {
    Properties {
        _MainTex ("Main Texture", 2D) = "white" {} // Dodajemy teksturê
    ...
    SubShader {
        ...
        Pass {
            ...
            sampler2D _MainTex; // Nowa tekstura
            sampler2D _WindTex;
            float4 _AOColor, _TipColor, _FogColor;
            ...
            v2f vert (VertexData v, uint instanceID : SV_INSTANCEID) {
                ...
                float4 localPosition = RotateAroundXInDegrees(v.vertex, 0.0f);//Zmiana z 90 na 0
            ...
            fixed4 frag (v2f i) : SV_Target {
                // Zamiast sta³ego koloru, pobieramy kolor z tekstury
                float4 texColor = tex2D(_MainTex, i.uv);
                
                // Odrzucamy piksele z alfa mniejsz¹ ni¿ 0.1
                clip(texColor.a - 0.1);
                ...
                float4 grassColor = (texColor + tip) * ndotl * ao;
